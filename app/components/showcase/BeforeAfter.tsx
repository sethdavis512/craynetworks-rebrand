...
/**
 * Reveal-slider comparison. The "after" sits on top, clipped from the right by an accessible
 * range input, so dragging right reveals more of the rebrand. Keyboard-operable by default.
 */
  ...
  return (
    <div>
      ...
      <label className="mt-4 block">
        <span className="font-sans text-xs text-muted">Drag to reveal the rebrand</span>
        <input
          type="range"
          min={0}
          max={100}
